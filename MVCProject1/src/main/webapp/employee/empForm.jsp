...
<form action="employeeWrite.emp" method="get" name="frm" id="frm" >
	직원 번호 : <input type="text" name="empNum" required="required" /><br /> 
	직원 이름 : <input type="text" name="empName" required="required" /><br /> 
	직원 아이디 : <input type="text" name="empId" required="required" /><br /> 
	...
	직원 이메일 : <input type="email" name="empEmail" /><br /> 
	직원 급여 : <input type="number" min="100" value="100" name="empSalary" /><br /> 
	직원 연락처 : <input type="tel" name="empPhone" placeholder="031-1234-1234" /><br /> 
