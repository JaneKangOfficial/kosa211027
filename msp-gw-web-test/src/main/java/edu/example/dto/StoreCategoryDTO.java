...
public class StoreCategoryDTO {
	...
	public String toString() {
		return "StoreCategoryDTO [storeNum=" + storeNum + ", employeeNum=" + employeeNum + ", employeeName="
				...
				+ ", leastPrice=" + leastPrice + ", startHoliday=" + startHoliday + ", endHoliday=" + endHoliday
				+ ", orderArea=" + orderArea + ", deliveryPrice=" + deliveryPrice + ", storeCategoryNum="
				+ storeCategoryNum + ", storeCategoryName=" + storeCategoryName + "]";
	}
